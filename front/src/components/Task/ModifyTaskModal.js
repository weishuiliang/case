					...
					if (response.data.status.toString() === '1') {
						...
						updateTask({
							...
							task: {
								...
								front_user_name: front_user.selectedText,
								back_user_name: back_user.selectedText,
								front_start_time: moment(front_time[0]).format('YYYY-MM-DD'),
								front_end_time: moment(front_time[1]).format('YYYY-MM-DD'),
								back_start_time: moment(back_time[0]).format('YYYY-MM-DD'),
								back_end_time: moment(back_time[1]).format('YYYY-MM-DD')
							},
						});
						// alert('更新成功');
					...
					>
						...
						>
							{getFieldDecorator('front_user', {
								initialValue: initialValue.front_user || null,
								rules: [{
						...
						>
							{getFieldDecorator('back_user', {
								initialValue: initialValue.back_user || null,
								rules: [{
