...
import { Modal, Button, Form, Icon, Input, Radio, Select } from 'antd'
				...
				<Form onSubmit={this.handleSubmit} className="login-form">
					...
					>
						{getFieldDecorator('role_type', {
							initialValue: `${positionInfo.role_type || ''}`,
							rules: [{message: '请输入职位类型' }],
						})(
							<RadioGroup name="radiogroup" >
								<Radio value={'1'}>前端工程师</Radio>
								<Radio value={'2'}>后端工程师</Radio>
							</RadioGroup>
						)}
					</FormItem>
					<FormItem
